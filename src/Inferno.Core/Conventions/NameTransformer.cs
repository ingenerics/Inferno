...
namespace Inferno.Core.Conventions
{
    /// <summary>
    ///  Class for managing the list of rules for doing name transformation.
    /// </summary>
    public class NameTransformer : List<NameTransformer.Rule>
    {
        ...
        public class Rule
        {
            ...
            /// </summary>
            public Regex GlobalFilterPatternRegex => _globalFilterPatternRegex ?? (_globalFilterPatternRegex = new Regex(GlobalFilterPattern, Options));

            /// <summary>
            /// Regular expression for replacing text
            /// </summary>
            public Regex ReplacePatternRegex => _replacePatternRegex ?? (_replacePatternRegex = new Regex(ReplacePattern, Options));
        }
    }
}