...
// This file may have been changed since it was pulled from the Splat repository.
...
{
    /// <summary>
    /// This data structure is a representation of a memoizing cache - i.e. a class that will evaluate a function,
    /// but keep a cache of recently evaluated parameters.
    ///
    /// Since this is a memoizing cache, it is important that this function is a "pure" function in the mathematical sense -
    /// that a key *always* maps to a corresponding return value.
    /// </summary>
