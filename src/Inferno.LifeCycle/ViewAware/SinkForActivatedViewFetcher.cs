...
namespace Inferno
{
    ...
    /// If we bind before view model activation is complete, the activation could trigger notifications and work on the UIThread that could otherwise be avoided.
    /// </summary>
